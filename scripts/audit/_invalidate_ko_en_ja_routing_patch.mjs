// Invalidate ko + en + ja word_entries + word_translations cache.
// Triggered by routing patches (2026-05-19 evening v2):
//   - KO NOUN_DA_WHITELIST → 사이다/캐나다/우간다 etc. now route to simple_word
//   - EN HYPHEN_COMPOUND_RE → long-term/well-known/Wi-Fi route to set_expression
//   - JA KATAKANA_VERB_RE → サボる/コピる/ググる route to verb_adj
//
// ZH + Latin unchanged this iteration. Tag: outdated-2026-05-19-v2.
...
const NEW_TAG = 'outdated-2026-05-19-v2';
const PAGE = 1000;
...
console.log(`\nDone. Next lookups for ${LANGS.join('/')} regenerate with the routing-patched case-routed prompts.`);
