// Invalidate Latin (es/fr/de/it) cache after 2026-05-19 evening Latin
// marker rule strengthening + Italian 42 headword_surface_invariant.
...
const NEW_TAG = 'outdated-2026-05-19-latin-v2';
const PAGE = 1000;
